...
790 PRINT"ENTER DATE SEARCH CRITERA":INPUTJJ$:L=LEN(JJ$):GOTO 830
800 PRINT"ENTER CAT SEARCH CRITERA":INPUTJJ$:L=LEN(JJ$):GOTO 840
810 PRINT"ENTER AMOUNT SEARCH CRITERA":INPUTJJ$:L=LEN(JJ$):GOTO 840
820 GOTO 760
...
1020 PRINT@480,"-mENU -rEDO -aDD -DEL##  ";:INPUTA$:IFA$="R"THEN 750
...
1260 PRINT"ENTER DATE SEARCH CRITERA":INPUTJJ$:L=LEN(JJ$):GOTO 1300
1270 PRINT"ENTER CAT SEARCH CRITERA":INPUTJJ$:L=LEN(JJ$):GOTO 1310
1280 PRINT"ENTER AMOUNT SEARCH CRITERA":INPUTJJ$:L=LEN(JJ$):GOTO 1310
1290 GOTO 1230
